...
This Android application integrates the Beacon platform into mCerebrum's data collection and processing system.
...
For the versions available, see [this repository's tags](https://github.com/MD2Korg/mCerebrum-Beacon/tags).

## Contributors

Link to the [list of contributors](https://github.com/MD2Korg/mCerebrum-Beacon/graphs/contributors) who participated in this project.
